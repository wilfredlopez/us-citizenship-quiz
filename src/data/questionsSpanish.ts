...
export const _OLDesQuestionsConstructor: QuestionContructor[] = [
  {
  ...
  },
  {
    ...
    correctAnswers: ["el presidente"],
    options: ["el presidente", "el congreso", "el senado", "la corte suprema"],
    number: 33,
  },
  {
  ...
  },
  {
    ...
    correctAnswers: ["democrático y republicano", "republicano y democrático"],
    options: [
...
export const questionsSpanish = esQuestionsConstructor.map(
  (params) => new Question(params)
);
